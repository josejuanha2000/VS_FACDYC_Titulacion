...
Public Class CR_Toma_Protesta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FDC_Titulacion.CR_Toma_Protesta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Toma_Protesta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Toma_Protesta = New CR_Toma_Protesta()
        rpt.Site = Me.Site
        Return rpt
    End Function
