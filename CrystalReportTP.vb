...
Public Class CrystalReportTP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FDC_Titulacion.CrystalReportTP.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Iniciales_() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrystalReportTP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportTP = New CrystalReportTP()
        rpt.Site = Me.Site
        Return rpt
    End Function
